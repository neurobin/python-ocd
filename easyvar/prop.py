...
from easyvar.mapattr import Attr
...
def make_fget(name, var_name, default=Void):
    ...
    def fget(self):
        ...
        if v is Void:
            raise AttributeError("Property '%s' is not set yet" % (name,))
        return v
    return fget
...
def make_fget_const(name, v):
    ...
    def fget(self):
        if v is Void:
            raise AttributeError("The value of property '%s' is non-existent. It can neither be read nor be written." % (name,))
        return v
    return fget
...
def make_fdel(name, var_name=None):
    ...
    def fdel(self):
        if var_name:
            ...
            raise AttributeError("Constant readonly property '%s' can not be deleted. It is being protected by %r" % (name, self.__class__,))
    return fdel
...
class Prop():
    ...
    def __init__(self, value=Void,
        ...
        self.readonly_for_class = readonly_for_class
...
class _Props():
    ...
    def __init__(self):
        ...
        class Keys(Attr): pass
        class Defaults(Attr): pass
        class Conf(Attr): pass
        class Ivan(Attr): pass
